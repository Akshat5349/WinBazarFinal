import 'package:azmatka/app/modules/home/controllers/jodi_winning_history_controller.dart';
import 'package:azmatka/constants/values.dart';

class JodiWinningHistoryView extends GetView<JodiWinningHistoryController> {
  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => JodiWinningHistoryController());
    return Scaffold(
      appBar: AppBar(
